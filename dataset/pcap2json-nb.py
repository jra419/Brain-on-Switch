...
def main():
    ...
    if not os.path.exists('./{}/json-nb'.format(args.dataset)):
        os.makedirs('./{}/json-nb'.format(args.dataset))

    for label in labels.keys():
        label_dir = './{}/json-nb/{}'.format(args.dataset, label)
    ...
    with open('./{}/json-nb/statistics_org.json'.format(args.dataset), 'w') as fp:
        json.dump({
